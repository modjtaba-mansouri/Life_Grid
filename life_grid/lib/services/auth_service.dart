...
class AuthService {
  ...
  Future<AuthResult> signUp({
    ...
    try {
      ...
      return AuthResult.fail(
        'Could not reach the server. If this keeps happening, check your internet connection.\n\nDetails: $e',
      );
    }
    if (existing != null) {
      return AuthResult.fail(
  ...
  Future<AuthResult> logIn({required String name, required String passcode}) async {
    ...
    try {
      ...
      return AuthResult.fail(
        'Could not reach the server, and there\'s no cached login on this device.\n\nDetails: $e',
      );
    }
    if (doc == null) {
